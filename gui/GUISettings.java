		...
		// ======== tabbedPane1 ========
		{
			...
			// ======== panel1 ========
			{
				...
				panel1Layout.setHorizontalGroup(panel1Layout.createParallelGroup().addGroup(
						panel1Layout
								...
								.addGroup(
										panel1Layout
												.createParallelGroup()
												.addGroup(panel1Layout.createSequentialGroup().addComponent(checkBox4, GroupLayout.PREFERRED_SIZE, 306, GroupLayout.PREFERRED_SIZE).addContainerGap(66, Short.MAX_VALUE))
												.addGroup(panel1Layout.createSequentialGroup().addComponent(checkBox5, GroupLayout.PREFERRED_SIZE, 306, GroupLayout.PREFERRED_SIZE).addContainerGap(66, Short.MAX_VALUE))
												.addGroup(panel1Layout.createSequentialGroup().addComponent(checkBox7, GroupLayout.PREFERRED_SIZE, 306, GroupLayout.PREFERRED_SIZE).addContainerGap(66, Short.MAX_VALUE))
												.addGroup(panel1Layout.createSequentialGroup().addComponent(checkBox8, GroupLayout.PREFERRED_SIZE, 306, GroupLayout.PREFERRED_SIZE).addContainerGap(66, Short.MAX_VALUE))
												.addGroup(panel1Layout.createSequentialGroup().addComponent(checkBox10, GroupLayout.PREFERRED_SIZE, 306, GroupLayout.PREFERRED_SIZE).addContainerGap(66, Short.MAX_VALUE))
												.addGroup(panel1Layout.createSequentialGroup().addComponent(checkBox2, GroupLayout.PREFERRED_SIZE, 320, GroupLayout.PREFERRED_SIZE).addContainerGap(52, Short.MAX_VALUE))
												.addGroup(
														GroupLayout.Alignment.TRAILING,
														panel1Layout.createSequentialGroup().addGap(12, 12, 12).addComponent(label2, GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
																.addComponent(textField2, GroupLayout.PREFERRED_SIZE, 212, GroupLayout.PREFERRED_SIZE))
												.addGroup(
														GroupLayout.Alignment.TRAILING,
														panel1Layout.createSequentialGroup().addComponent(label1, GroupLayout.PREFERRED_SIZE, 158, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
				...
				panel1Layout.setVerticalGroup(panel1Layout.createParallelGroup().addGroup(
						panel1Layout.createSequentialGroup().addGap(10, 10, 10)
								.addGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(textField1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent(label1, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE))
								.addGap(5, 5, 5)
								.addGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(textField2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent(label2, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(checkBox2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addGap(4, 4, 4).addComponent(checkBox4).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(checkBox5).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(checkBox7).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(checkBox8).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(checkBox10)
								.addGap(20, 20, 20)));
			}
			...
			// ======== panel4 ========
			{
				...
				panel4Layout.setVerticalGroup(panel4Layout.createParallelGroup().addGroup(
						panel4Layout.createSequentialGroup().addGap(8, 8, 8).addComponent(label9, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(textField8, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
								.addGap(18, 18, 18).addComponent(checkBox6, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addGap(30, 30, 30).addComponent(button3, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE).addContainerGap(69, Short.MAX_VALUE)));
			}
			...
			// ======== panel5 ========
			{
				...
				panel5Layout.setHorizontalGroup(panel5Layout
						.createParallelGroup()
						.addGroup(GroupLayout.Alignment.TRAILING, panel5Layout.createSequentialGroup().addGap(72, 72, 72).addComponent(textField9, GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE).addGap(129, 129, 129).addComponent(button4).addGap(89, 89, 89))
						.addGroup(panel5Layout.createSequentialGroup().addContainerGap().addComponent(textField10, GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE).addContainerGap())
						.addGroup(panel5Layout.createSequentialGroup().addContainerGap().addComponent(textField13, GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE).addContainerGap())
						.addGroup(
								panel5Layout
										.createSequentialGroup()
										.addGap(60, 60, 60)
										.addGroup(
												panel5Layout.createParallelGroup().addComponent(textField12, GroupLayout.PREFERRED_SIZE, 247, GroupLayout.PREFERRED_SIZE).addComponent(textField11, GroupLayout.PREFERRED_SIZE, 247, GroupLayout.PREFERRED_SIZE)
														.addComponent(textField3, GroupLayout.PREFERRED_SIZE, 247, GroupLayout.PREFERRED_SIZE)).addContainerGap(77, Short.MAX_VALUE)));
				panel5Layout.setVerticalGroup(panel5Layout.createParallelGroup().addGroup(
						panel5Layout
								.createSequentialGroup()
								.addGroup(
										panel5Layout.createParallelGroup().addGroup(panel5Layout.createSequentialGroup().addContainerGap().addComponent(textField10, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
												.addGroup(panel5Layout.createSequentialGroup().addGap(40, 40, 40).addComponent(textField13, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
								.addGroup(panel5Layout.createParallelGroup().addComponent(button4).addComponent(textField9, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(textField3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18).addComponent(textField11, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18)
								.addComponent(textField12, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
			}
			...
			// ======== panel2 ========
			{
				...
				panel2Layout.setVerticalGroup(panel2Layout.createParallelGroup().addGroup(
						panel2Layout.createSequentialGroup().addGap(10, 10, 10)
								...
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 14, Short.MAX_VALUE).addComponent(label3).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(label7, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)));
			}
